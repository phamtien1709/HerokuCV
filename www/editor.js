...
(function ($) {
    ...
    var methods = {
        ...
        imageWidget: function () {
            ...
            var imageList = $('<ul/>', { class: 'thumbnails padding-top list-unstyled', id: 'imageList_' + _idSuffix }).appendTo(imageListContainer);
        ...
        init: function (options) {
            ...
            var menuItems = {
                ...
                styles: { select: true, default: 'Formatting', tooltip: 'Paragraph Format', commandname: 'formatBlock', custom: null },
                ...
                color: {
                    ...
                    custom: function (button) {
                        var editor = $(this);
                        var flag = 0;
                        var paletteCntr = $('<div/>', { id: 'paletteCntr', class: 'activeColour', css: { display: 'none', width: '335px' } }).click(
                            function (event) {
                ...
                strikeout: { text: 'Strikeout', icon: 'fa fa-strikethrough', tooltip: 'Strike Through', commandname: 'strikeThrough', custom: null },

                ol: { text: 'N', icon: 'fa fa-list-ol', tooltip: 'Insert/Remove Numbered List', commandname: 'insertorderedlist', custom: null },
                ...
                l_align: { text: 'leftalign', icon: 'fa fa-align-left', tooltip: 'Align Left', commandname: 'justifyleft', custom: null },

                r_align: { text: 'rightalign', icon: 'fa fa-align-right', tooltip: 'Align Right', commandname: 'justifyright', custom: null },

                c_align: { text: 'centeralign', icon: 'fa fa-align-center', tooltip: 'Align Center', commandname: 'justifycenter', custom: null },

                justify: { text: 'justify', icon: 'fa fa-align-justify', tooltip: 'Justify', commandname: 'justifyfull', custom: null },
                ...
                hr_line: { text: 'HR', icon: 'fa fa-minus', tooltip: 'Horizontal Rule', commandname: 'insertHorizontalRule', custom: null },
                ...
                indent: { text: 'Indent', icon: 'fa fa-indent', tooltip: 'Increase Indent', commandname: 'indent', custom: null },

                outdent: { text: 'Outdent', icon: 'fa fa-outdent', tooltip: 'Decrease Indent', commandname: 'outdent', custom: null },
                ...
                print: {
                    ...
                    custom: function () {
                        ...
                        oPrntWin.document.write(
                            '<!doctype html><html><head><title>Print</title></head><body onload="print();">' + oDoc.html() + '</body></html>'
                        );
                        oPrntWin.document.close();
                    },
                },

                rm_format: { text: 'Remove format', icon: 'fa fa-eraser', tooltip: 'Remove Formatting', commandname: 'removeformat', custom: null },
            ...
            var menuBar = $('<div/>', { id: 'menuBarDiv_' + $(this).attr('id'), class: 'row-fluid line-control-menu-bar' }).prependTo(containerDiv);
            var editor = $('<div/>', { class: 'Editor-editor', css: { overflow: 'auto' }, contenteditable: 'true' }).appendTo(containerDiv);
            var statusBar = $('<div/>', {
        ...
        createModal: function (modalId, modalHeader, modalBody, onSave) {
            ...
            var modalTrigger = $('<a/>', { href: '#' + modalId, role: 'button', class: 'btn btn-default', 'data-toggle': 'modal' });
